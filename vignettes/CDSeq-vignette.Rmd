...
```{r quick start, echo=TRUE, eval=FALSE,class.source='klippy'}
...
```{r fig1, echo=TRUE,cache=FALSE,eval=TRUE,class.source='klippy', fig.width=7,fig.height=5,fig.align = 'center'}
...
```{r fig2, echo=TRUE,cache=FALSE,eval=TRUE,class.source='klippy',fig.width=7,fig.height=5,fig.align = 'center'}
...
For this dataset and given parameter setings, CDSeq took this much amount of time to finish:
...
```{r example 2, echo=TRUE ,eval=FALSE, cache=FALSE, results='hide',class.source='klippy'}
...
```{r fig3, echo=TRUE, eval=TRUE, class.source='klippy',fig.width=7,fig.height=5,fig.align = 'center'}
...
```{r fig4, echo=TRUE, eval=TRUE, class.source='klippy', fig.width=7,fig.height=5,fig.align = 'center'}
...
```{r fig5,echo=TRUE, eval=TRUE, class.source='klippy', fig.width=7,fig.height=6,fig.align = 'center'}
lgpst <- rep(0,9)
for (i in 1:9) {
...
```{r fig6, echo=TRUE, eval=TRUE, class.source='klippy',fig.width=7,fig.height=5,fig.align = 'center'}
...
```{r fig7, echo=TRUE, eval=TRUE, class.source='klippy',fig.width=7,fig.height=5,fig.align = 'center'}
...
```{r example 4, echo=TRUE, eval=FALSE, cache=FALSE, results='hide',class.source='klippy'}
...
```{r fig8, echo=TRUE, eval=TRUE, class.source='klippy', results='hide',message=FALSE, warning=FALSE}
...
```{r show GEP vs scRNAseq, echo=TRUE, eval=TRUE, fig.width = 20, fig.height = 70, class.source='klippy',fig.align = 'center',out.width = "95%"}
...
```{r prepare df for ggplot, echo=TRUE, eval=FALSE, class.source='klippy'}
for (i in 1:4) {
  if(i==1){
...
```{r compare GEP, echo=TRUE, eval=TRUE, class.source='klippy',results='hide', message=FALSE}
