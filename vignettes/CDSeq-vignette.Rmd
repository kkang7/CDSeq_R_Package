...
We provide recommendations for parameter settings. Note that these recommendations are merely emperical and there is no theoretical justifications yet. User is encouraged to tune the parameters based on specific applications and domain knowledges. 
...
The following is still working in progress....
