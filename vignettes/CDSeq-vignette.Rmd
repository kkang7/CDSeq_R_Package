...
The output *result* is a list containing multiple entities as listed in [Output](#output). When *cell_type_number* is a scalar, **CDSeq** will only returnt the following values.
```{r output, eval=FALSE, echo=TRUE}
ls(result1)
```
We can compare the CDSeq-estimated cell-type-specific GEPs with the ground truth.
```{r fig1, echo=TRUE,cache=FALSE,eval=FALSE}
